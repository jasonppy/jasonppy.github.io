...
I'm a 4th year (final year) PhD student at [UT Austin](https://www.utexas.edu/) and part-time student researcher at [FAIR, Meta]((https://ai.meta.com/)) **I'll be graduating in May 2025 and on the job market, please reach out if interested!**. I have published first-authored papers on speech & audio recognition and generation in Interspeech/ICASSP/ACL/ECCV. In particular, the tasks on which I have published first-authored papers include:
